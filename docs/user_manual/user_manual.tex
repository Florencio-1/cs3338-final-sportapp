...
As of Snapshot 2 (Checkpoint 1), the focus is on the
\textbf{All Games} view. A basic page for listing games and filtering by
sport is implemented on the frontend using sample data. Favorites and admin
features will be added and documented in later snapshots.
