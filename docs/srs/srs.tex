...
\begin{itemize}
    ...
    \item \textbf{Database:} MongoDB for storing users, teams, and game schedules.
\end{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Database:} MongoDB (containerized).
...
\begin{itemize}
    ...
    \item React should be used on the frontend; Node.js/Express on the backend; MongoDB for persistence.
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item \texttt{GET /api/users/me/favorites} \\
              Returns the list of favorite teams for the logged-in user.
        \item \texttt{POST /api/users/me/favorites} \\
              Adds a team to the user's favorites.
        \item \texttt{DELETE /api/users/me/favorites/:teamId} \\
...
\begin{itemize}
    \item \texttt{users}: user credentials, profile data, and favorite teams.
    \item \texttt{teams}: team name, sport, and optionally logo/metadata.
    \item \texttt{games}: participating teams, sport, date/time, and scores.
\end{itemize}
