...
\hline
0.1 & 2024-11-24 & Initial draft for Snapshot 1 \\
\hline
0.2 & 2025-12-10 & Snapshot 3: Favorites flow design, API planning, updated UI notes \\
\hline
...
\begin{itemize}
  ...
  \item \textbf{Runtime stack (current snapshot)} – Node.js 20 with Express
        and CORS middleware for the mock API, plus nginx to serve the static
        frontend container. Favorites persist locally until database wiring is
        completed.
\end{itemize}
